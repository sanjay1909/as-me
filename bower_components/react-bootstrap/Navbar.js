      ...
      if (this.props.brand) {
        if (_React.isValidElement(this.props.brand)) {
          brand = (0, _react.cloneElement)(this.props.brand, {
            className: (0, _classNames)(this.props.brand.props.className, 'navbar-brand')
          });
        } else {
    ...
    renderToggleButton: function renderToggleButton() {
      ...
      if (_React.isValidElement(this.props.toggleButton)) {
        ...
        return (0, _react.cloneElement)(this.props.toggleButton, {
          className: (0, _classNames)(this.props.toggleButton.props.className, 'navbar-toggle'),
          onClick: (0, _createChainedFunction)(this.handleToggle, this.props.toggleButton.props.onClick)
        });
      }
