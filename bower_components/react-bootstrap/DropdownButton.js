  ...
  var DropdownButton = _React.createClass({
    ...
    render: function render() {
      ...
      return this[renderMethod]([_React.createElement(
        ...
        _extends({}, this.props, {
          ref: 'dropdownButton',
          className: (0, _classNames)('dropdown-toggle', this.props.buttonClassName),
    ...
    renderButtonGroup: function renderButtonGroup(children) {
      ...
      return _React.createElement(
        _ButtonGroup2,
        {
          ...
          className: (0, _classNames)(this.props.className, groupClasses) },
        children
      );
    },
    ...
    renderMenuItem: function renderMenuItem(child, index) {
      ...
      return (0, _react.cloneElement)(child, {
        ...
        onSelect: (0, _createChainedFunction)(child.props.onSelect, handleOptionSelect),
