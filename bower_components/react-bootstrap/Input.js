define(['exports', 'module', 'react', './InputBase', './ButtonInput', './utils/deprecationWarning'], function (exports, module, _react, _InputBase2, _ButtonInput, _utilsDeprecationWarning) {
  'use strict';
    ...
    _createClass(Input, [{
      ...
      value: function render() {
        if (buttonTypes.indexOf(this.props.type) > -1) {
          (0, _deprecationWarning)('Input type=' + this.props.type, 'ButtonInput');
          return _React.createElement(_ButtonInput2, this.props);
        }
